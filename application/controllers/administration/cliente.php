        ...
        public function deshabilitarbd(){
            if($this->session->userdata('login'))
            {
                ...
                if($tipo=='ADMINISTRADOR'){
                    ...
                    redirect('administration/empleado/index','refresh'); //Redirecciona a empleados //operacion no valida para el empleado
        ...
        public function deshabilitados(){
            if($this->session->userdata('login'))
            {
                ...
                if($tipo=='ADMINISTRADOR'){
                    ...
                    redirect('administration/empleado/index','refresh'); //Funcion no valida para empleado
                }
            }
            else
            {
        ...
        public function habilitarbd(){
            if($this->session->userdata('login'))
            {
                ...
                if($tipo=='ADMINISTRADOR'){
                    ...
                    redirect('administration/empleado/index','refresh'); //Operacion no valida pentiente desarrollar modal de alerta
                }
            }
            else
            {
