...
-->
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-5 col-sm-5 col-xs-5">
                                            <input type="hidden" name="detalle_data" id="detalle_data" value="" required>
                                            <!--Seleccionar productos en lista-->
                                            <input class="form-control" type="text" id="autoproduct" name="producto" required> <!--VALORES TEXT-->
                                        ...
                                        <table class="table table-striped" id="tabla-ventas">
                                            ...
                                            <tbody class="list-product">
                                                <tr id="fila-ejemplo" style="display: none;">
                                                    ...
                                                    <td><input style="width: 70px;" type="number" required value="0" class="form-control descuento" name="descuento[]" id="descuento" onkeypress="return soloNumeros(event)"></td> <!--descuento-->
                                                    <td><input style="width: 70px;" type="number" required value="0" class="form-control cantidad" name="cantidad[]" id="cantidad" onkeypress="return soloNumeros(event)"></td> <!--cantidad para llevar-->
